          ...
          <div className="space-y-4">
              ...
              <div className="flex-1">
                ...
                {editingName ? (
                  <div className="flex items-center gap-2 mt-1">
                    ...
                    <button onClick={() => { setEditingName(false); setName(profile?.name || ""); }} className="px-3 py-2 border border-border rounded-lg text-sm hover:bg-muted">
                      Cancel
                    </button>
                  </div>
                ) : (
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-foreground mt-1 capitalize">{profile?.role}</p>
              </div>
            </div>
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                <p className="text-xs text-muted-foreground uppercase tracking-wider font-medium">Account Created</p>
              ...
              <div>
                ...
                <div className="relative">
                  <input
                    ...
                    className="w-full px-3 py-2.5 pr-10 border border-input rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-ring bg-background"
