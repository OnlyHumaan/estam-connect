...
const STATUSES_LIST = ["All", "Pending", "Under Review", "In Progress", "Resolved", "Closed"];
    ...
    <div className="min-h-screen bg-secondary">
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-8 animate-slide-up">
          ...
          <Link
            to="/submit-complaint"
            className="inline-flex items-center gap-2 bg-primary text-primary-foreground px-5 py-2.5 rounded-xl text-sm font-semibold hover:opacity-90 transition-opacity active:scale-[0.98] self-start"
          >
        ...
        <div className="bg-card rounded-xl shadow-sm border border-border animate-slide-up" style={{ animationDelay: "240ms" }}>
          {loading ? (
            ...
            <div className="p-12 text-center">
              ...
              <Link to="/submit-complaint" className="inline-block mt-4 text-sm text-primary font-medium hover:underline">
                ...
                <table className="w-full text-sm">
                  <thead>
                    <tr className="border-b border-border">
                      ...
                      <th className="text-left px-6 py-4 font-semibold text-primary uppercase text-xs tracking-wider">Category</th>
                      <th className="text-left px-6 py-4 font-semibold text-primary uppercase text-xs tracking-wider">Status</th>
                      <th className="text-left px-6 py-4 font-semibold text-primary uppercase text-xs tracking-wider">Date Submitted</th>
                      ...
                      <tr key={c.id} className="border-b border-border last:border-0 hover:bg-muted/30 transition-colors">
                        ...
                        <td className="px-6 py-5">
                          <div className="flex items-center gap-3">
                            ...
                            <span className="font-medium text-foreground">{profile?.name || "Unknown"}</span>
                          </div>
                        </td>
                        ...
                        <td className="px-6 py-5">
                          <div className="flex items-center gap-3">
                            <Link to={`/complaint/${c.id}`} className="text-muted-foreground hover:text-primary transition-colors" title="View">
                              <Eye className="h-5 w-5" />
                            </Link>
                            <Link to={`/complaint/${c.id}`} className="text-muted-foreground hover:text-primary transition-colors" title="Edit">
